<template>
  <!-- Navigator -->
  <!-- <div class="m-auto md:max-w-2xl space-y-6">
    <nav class="flex items-center max-w-md mx-auto md:mx-0 my-3">
  ...
  <!-- <div class="m-auto md:max-w-2xl space-y-6">
    <nav class="flex-none flex items-center max-w-md mx-auto md:mx-0 my-4">
  ...
  <nav
    class="sticky top-0 z-40 lg:z-50 w-full h-16 md:max-w-2xl mx-auto bg-white flex-none flex rounded-b-xl"
  >
    <div
